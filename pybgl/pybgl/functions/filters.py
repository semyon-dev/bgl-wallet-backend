import struct
import io
from pybgl.functions.tools import int_to_var_int, read_var_int, var_int_to_int
from  math import log, ceil, floor, log2
from pybgl.constants import LN2SQUARED, LN2
from pybgl.functions.tools import  map_into_range, get_stream
from pybgl.functions.hash import siphash, murmurhash3
